...
app.post("/submit", (req, res) => {
  ...
  bandName = `${randomWord(adj)} ${randomWord(noun)}`;
  res.redirect("/");
  // res.render("index.ejs",{name:`${randomWord(adj)} ${randomWord(noun)}`})
});
...
function randomWord(itemOf) {
  return itemOf[Math.floor(Math.random() * itemOf.length)];
}
